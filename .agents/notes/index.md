...
- [btleplug BlueZ scanner: the stream can hang (not just end); the RTL8761 dongle stalls; PeripheralId carries the hciN prefix](ble/2026-08-scanner-resilience.md) — bugfix, btleplug, bluez, scanner, adapter, dbus, usb, realtek, autosuspend — 2026-08-28, upd 2026-09-21
